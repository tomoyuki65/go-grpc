...
const file_sample_sample_proto_rawDesc = "" +
	"\n" +
	"\x13sample/sample.proto\x12\x06sample\x1a\x17validate/validate.proto\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\a\n" +
	"\x05Empty\"-\n" +
...
var file_sample_sample_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
